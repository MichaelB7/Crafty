...
inline uint16_t bswap16(uint16_t x) {
  return (uint16_t) ((((uint16_t) (x) & 0xff00) >> 8) | (((uint16_t) (x) &
              0x00ff) << 8));
}
#      endif
#    endif
...
inline uint32_t bswap32(uint32_t x) {
  return ((x & 0xff000000) >> 24) | ((x & 0x00ff0000) >> 8) | ((x &
...
inline uint64_t bswap64(uint64_t x) {
  return ((x & 0xff00000000000000ull) >> 56) | ((x & 0x00ff000000000000ull) >>
      40) | ((x & 0x0000ff0000000000ull) >> 24) | ((x & 0x000000ff00000000ull)
      >> 8) | ((x & 0x00000000ff000000ull) << 8) | ((x &
          0x0000000000ff0000ull) << 24) | ((x & 0x000000000000ff00ull) << 40)
